...
ls -l $WORKING_DIR/../../berlin_config/$CUST_SELFKEY_IMAGE
...
cp $WORKING_DIR/../../berlin_config/${CUST_KEY_IMAGE} ../IMAGE/Key_Injection/SI_cust_key
...
$ADDHEADER_TOOL $WORKING_DIR/../../berlin_config/${CUST_KEY_IMAGE} key.img || exit 1
