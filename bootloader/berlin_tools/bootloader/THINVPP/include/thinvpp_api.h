...
typedef struct VPP_SCL_CTRL_T
{
    ...
    //unsigned char HCoeffSigned;     // should set to 1
    //unsigned char HCoeffFracNum; // 8~12
    //unsigned char VCoeffSigned;     // 1
    //unsigned char VCoeffFracNum;  //8~12

    unsigned char  CscMode;                   //used when the input is OSD
    unsigned char  CenterFrac;//used when enable NL scaling

//    unsigned char HtapOff;
//    unsigned char VtapOffE; //default value is ok
//    unsigned char VtapOffO;//default value is ok
