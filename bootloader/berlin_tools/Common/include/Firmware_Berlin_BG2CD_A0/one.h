//////
/// don't edit! auto-generated by docc: one.h
////////////////////////////////////////////////////////////
#ifndef one_h
#define one_h (){}
...
//////
/// 
/// $INTERFACE oneHboTCMEntry                           (4,4)
///     # # ----------------------------------------------------------
///     @ 0x00000                      (P)
///               %unsigned 32 word                      0x1
///                                    ###
///                                    * Defines a TCM entry, the minimum bus widht is 32.
///                                    * It could be 32/64/128
///                                    * End of TCMEntry
///                                    ###
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:       4B, bits:      32b, padding:     0B
////////////////////////////////////////////////////////////
#ifndef h_oneHboTCMEntry
#define h_oneHboTCMEntry (){}

    #define     BA_oneHboTCMEntry_word                         0x0000
    #define     B16oneHboTCMEntry_word                         0x0000
    #define   LSb32oneHboTCMEntry_word                            0
    #define   LSb16oneHboTCMEntry_word                            0
    #define       boneHboTCMEntry_word                         32
    #define   MSK32oneHboTCMEntry_word                            0xFFFFFFFF
    ///////////////////////////////////////////////////////////

    typedef struct SIE_oneHboTCMEntry {
    ///////////////////////////////////////////////////////////
    #define   GET32oneHboTCMEntry_word(r32)                    _BFGET_(r32,31, 0)
    #define   SET32oneHboTCMEntry_word(r32,v)                  _BFSET_(r32,31, 0,v)
    ...
    ///////////////////////////////////////////////////////////
     SIGN32 oneHboTCMEntry_drvrd(SIE_oneHboTCMEntry *p, UNSG32 base, SIGN32 mem, SIGN32 tst);
     SIGN32 oneHboTCMEntry_drvwr(SIE_oneHboTCMEntry *p, UNSG32 base, SIGN32 mem, SIGN32 tst, UNSG32 *pcmd);
       void oneHboTCMEntry_reset(SIE_oneHboTCMEntry *p);
     SIGN32 oneHboTCMEntry_cmp  (SIE_oneHboTCMEntry *p, SIE_oneHboTCMEntry *pie, char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
    #define oneHboTCMEntry_check(p,pie,pfx,hLOG) oneHboTCMEntry_cmp(p,pie,pfx,(void*)(hLOG),0,0)
    #define oneHboTCMEntry_print(p,    pfx,hLOG) oneHboTCMEntry_cmp(p,0,  pfx,(void*)(hLOG),0,0)

#endif
//////
/// ENDOFINTERFACE: oneHboTCMEntry
////////////////////////////////////////////////////////////

//////
/// 
/// $INTERFACE oneHboTCM                                (4,4)
///     # # ----------------------------------------------------------
///     @ 0x00000                      (P)
///     # 0x00000 tbl                  
///               $oneHboTCMEntry      tbl               REG   [16384]
///                                    ###
///                                    * Defines a TCM memory.
///                                    * End of TCM
///                                    ###
///     # # ----------------------------------------------------------
...
#define h_oneHboTCM (){}
    ...
    #define     RA_oneHboTCM_tbl                               0x0000
    ///////////////////////////////////////////////////////////

    typedef struct SIE_oneHboTCM {
    ///////////////////////////////////////////////////////////
              SIE_oneHboTCMEntry                               ie_tbl[16384];
    ///////////////////////////////////////////////////////////
    } SIE_oneHboTCM;

    ///////////////////////////////////////////////////////////
     SIGN32 oneHboTCM_drvrd(SIE_oneHboTCM *p, UNSG32 base, SIGN32 mem, SIGN32 tst);
     SIGN32 oneHboTCM_drvwr(SIE_oneHboTCM *p, UNSG32 base, SIGN32 mem, SIGN32 tst, UNSG32 *pcmd);
       void oneHboTCM_reset(SIE_oneHboTCM *p);
     SIGN32 oneHboTCM_cmp  (SIE_oneHboTCM *p, SIE_oneHboTCM *pie, char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
    #define oneHboTCM_check(p,pie,pfx,hLOG) oneHboTCM_cmp(p,pie,pfx,(void*)(hLOG),0,0)
    #define oneHboTCM_print(p,    pfx,hLOG) oneHboTCM_cmp(p,0,  pfx,(void*)(hLOG),0,0)

#endif
//////
/// ENDOFINTERFACE: oneHboTCM
////////////////////////////////////////////////////////////

//////
/// 
/// $INTERFACE one                     biu              (4,4)
///     ###
///     * one DTCM, occupying 16KB address space
///     ###
///     # # ----------------------------------------------------------
///     @ 0x00000 TCM                  (P)
///     # 0x00000 dtcm                 
...
///               %% 509952
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:  131072B, bits:    1952b, padding:     0B
////////////////////////////////////////////////////////////
#ifndef h_one
#define h_one (){}

    #define     RA_one_TCM                                     0x0000
    #define     RA_one_dtcm                                    0x0000
    ///////////////////////////////////////////////////////////
    #define     RA_one_HBO                                     0x10000
    #define     RA_one_hbo                                     0x10000
    ///////////////////////////////////////////////////////////

    typedef struct SIE_one {
    ///////////////////////////////////////////////////////////
              SIE_oneHboTCM                                    ie_dtcm;
    ///////////////////////////////////////////////////////////
              SIE_HBO                                          ie_hbo;
    ///////////////////////////////////////////////////////////
             UNSG8 RSVDx10700                                  [63744];
    ///////////////////////////////////////////////////////////
    } SIE_one;

    ///////////////////////////////////////////////////////////
     SIGN32 one_drvrd(SIE_one *p, UNSG32 base, SIGN32 mem, SIGN32 tst);
     SIGN32 one_drvwr(SIE_one *p, UNSG32 base, SIGN32 mem, SIGN32 tst, UNSG32 *pcmd);
       void one_reset(SIE_one *p);
     SIGN32 one_cmp  (SIE_one *p, SIE_one *pie, char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
    #define one_check(p,pie,pfx,hLOG) one_cmp(p,pie,pfx,(void*)(hLOG),0,0)
    #define one_print(p,    pfx,hLOG) one_cmp(p,0,  pfx,(void*)(hLOG),0,0)
