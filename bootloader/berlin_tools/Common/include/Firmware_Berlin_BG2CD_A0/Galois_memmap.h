...
///                            ###
///                            * 64KB has 16-bit offset
///                            * Memory map RESERVED – not used. Was used in BG2A0 for CORESIGHT_REG_BASE
///                            ###
///               : RESERVED_REG_BASE  0xF7B60000
///                            ###
///                            * Base address for RESERVED Registers
///                            * 64KB
///                            * Size of RESERVED – not used
///                            ###
///               : RESERVED_REG_SIZE  0x10000
///                            ###
///                            * Size of RESERVED Registers
///                            * Address decoding bit – not used
///                            ###
///               : RESERVED_REG_DEC_BIT 0x10
///                            ###
///                            * 64KB has 16-bit offset
...
///                            ###
///               : AVIO_RESR3_BASE    0xF7E20000
///                            ###
///                            * Base address for AVIO Reserve3 Registers
///                            * 64 KB
///                            ###
///               : AVIO_RESR3_SIZE    0x10000
///                            ###
///                            * Size of AVIO Reserve3 Registers
///                            ###
///               : AVIO_RESR3_DEC_BIT 0x10
///                            ###
///                            * 64 KB has a 16-bit offset
///                            ###
...
///                            * 64 KB has a 16 bits offset
///                            ###
///               : GFX_REG_BASE       0xF7EF0000
///                            ###
///                            * Base address of Graphics control Registers
///                            * 64 KB
///                            ###
///               : GFX_REG_SIZE       0x10000
///                            ###
///                            * Size of GFX Registers memory mapping
///                            ###
///               : GFX_REG_DEC_BIT    0x10
///                            ###
///                            * 64 KB has a 16 bits offset
///                            ###
...
#define h_MEMMAP (){}
    ...
    #define        MEMMAP_SLOW_REG_BASE                        0xF7A00000
    ...
    #define        MEMMAP_RESERVED_REG_BASE                    0xF7B60000
    #define        MEMMAP_RESERVED_REG_SIZE                    0x10000
    #define        MEMMAP_RESERVED_REG_DEC_BIT                 0x10
