...
/**********************************************************************************************************************
*	INTERFACE: cmn
*	`  Defines the Registers common to all the PICs.
*	@  fSrcPolSel0  (P)
*	`  Defines the PIC0 Polarity of Fast interrupt sources
*			%unsigned  32  pol  0
*						*  					*  *
*						*  					*  Polarity. 1 – Active high, 0 – Active low.
*						*  					*  POL[0] defines the polarity of interrupt source 0.
*	@  fSrcPolSel1  (P)
*	`  Defines the PIC1Polarity of Fast interrupt sources
*			%unsigned  32  pol  0
*						*  					*  *
*						*  					*  Polarity. 1 – Active high, 0 – Active low.
*						*  					*  POL[0] defines the polarity of interrupt source 0.
*	@  fSrcPolSel2  (P)
*	`  Defines the PIC2 Polarity of Fast interrupt sources
*			%unsigned  32  pol  0
*						*  					*  *
*						*  					*  Polarity. 1 – Active high, 0 – Active low.
*						*  					*  POL[0] defines the polarity of interrupt source 0.
*	@  fSrcSensSel0  (P)
*	`  Defines the PIC0 Sensitivity of Fast interrupt sources
*			%unsigned  32  sens  0
*						*  					*  *
*						*  					*  Sensitivity. 1 – Edge triggered, 0 – level triggered.
*						*  					*  SENS[0] defines the sensitivity of interrupt source 0.
*						*  					*  NOTE: Software must always program 0, as edge triggered interrupt source is no more supported.
*	@  fSrcSensSel1  (P)
*	`  Defines the PIC1 Sensitivity of Fast interrupt sources
*			%unsigned  32  sens  0
*						*  					*  *
*						*  					*  Sensitivity. 1 – Edge triggered, 0 – level triggered.
*						*  					*  SENS[0] defines the sensitivity of interrupt source 0.
*						*  					*  NOTE: Software must always program 0, as edge triggered interrupt source is no more supported.
*	@  fSrcSensSel2  (P)
*	`  Defines the PIC2 Sensitivity of Fast interrupt sources
*			%unsigned  32  sens  0
*						*  					*  *
*						*  					*  Sensitivity. 1 – Edge triggered, 0 – level triggered.
*						*  					*  SENS[0] defines the sensitivity of interrupt source 0.
*						*  					*  NOTE: Software must always program 0, as edge triggered interrupt source is no more supported.
*	@  fIntSts0  (R)
*	`  PIC0 Interrupt Status of Fast interrupt sources
*			%unsigned  1  ists  0  [32]
*						*  					*  *
*						*  					*  Interrupt Status for all the sources.
*						*  					*  1 : interrupt is asserted when IE[x] is active.
*						*  					*  0 : no interrupt is asserted because of ISTS[x].
*	@  fIntSts1  (R)
*	`  PIC1 Interrupt Status of Fast interrupt sources
*			%unsigned  1  ists  0  [32]
*						*  					*  *
*						*  					*  Interrupt Status for all the sources.
*						*  					*  1 : interrupt is asserted when IE[x] is active.
*						*  					*  0 : no interrupt is asserted because of ISTS[x].
*	@  fIntSts2  (R)
*	`  PIC2 Interrupt Status of Fast interrupt sources
*			%unsigned  1  ists  0  [32]
*						*  					*  *
*						*  					*  Interrupt Status for all the sources.
*						*  					*  1 : interrupt is asserted when IE[x] is active.
*						*  					*  0 : no interrupt is asserted because of ISTS[x].
*	@  nSrcPolSel0  (P)
*	`  Defines the PIC0 Polarity of Normal interrupt sources
*			%unsigned  32  pol  0
*						*  					*  *
*						*  					*  Polarity. 1 – Active high, 0 – Active low.
*						*  					*  POL[0] defines the polarity of interrupt source 0.
*	@  nSrcPolSel1  (P)
*	`  Defines the PIC1 Polarity of Normal interrupt sources
*			%unsigned  32  pol  0
*						*  					*  *
*						*  					*  Polarity. 1 – Active high, 0 – Active low.
*						*  					*  POL[0] defines the polarity of interrupt source 0.
*	@  nSrcPolSel2  (P)
*	`  Defines the PIC2 Polarity of Normal interrupt sources
*			%unsigned  32  pol  0
*						*  					*  *
*						*  					*  Polarity. 1 – Active high, 0 – Active low.
*						*  					*  POL[0] defines the polarity of interrupt source 0.
*	@  nSrcSensSel0  (P)
*	`  Defines the PIC0 Sensitivity of Normal interrupt sources
*			%unsigned  32  sens  0
*						*  					*  *
*						*  					*  Sensitivity. 1 – Edge triggered, 0 – level triggered.
*						*  					*  SENS[0] defines the sensitivity of interrupt source 0.
*						*  					*  NOTE: Software must always program 0, as edge triggered interrupt source is no more supported.
*	@  nSrcSensSel1  (P)
*	`  Defines the PIC1 Sensitivity of Normal interrupt sources
*			%unsigned  32  sens  0
*						*  					*  *
*						*  					*  Sensitivity. 1 – Edge triggered, 0 – level triggered.
*						*  					*  SENS[0] defines the sensitivity of interrupt source 0.
*						*  					*  NOTE: Software must always program 0, as edge triggered interrupt source is no more supported.
*	@  nSrcSensSel2  (P)
*	`  Defines the PIC2 Sensitivity of Normal interrupt sources
*			%unsigned  32  sens  0
*						*  					*  *
*						*  					*  Sensitivity. 1 – Edge triggered, 0 – level triggered.
*						*  					*  SENS[0] defines the sensitivity of interrupt source 0.
...
*			%unsigned  1  ists  0  [32]
*						*  					*  *
*						*  					*  Interrupt Status. ISTS[0] is for interrupt source 0.
*						*  					*  1 : interrupt is asserted when IE[0] is active.
*						*  					*  0 : no interrupt is asserted because of ISTS[0].
*	@  nIntSts1  (R)
*	`  PIC1 Interrupt Status of Fast interrupt sources
*			%unsigned  1  ists  0  [32]
*						*  					*  *
...
/**********************************************************************************************************************
*	INTERFACE: perPIC
*	`  Defines the Registers per PIC.
*	@  fTgtPolSel  (P)
*	`  Defines the Polarity of Fast interrupt target(s).
*			%unsigned  1  pol  0
*						*  					*  *
*						*  					*  Polarity. 1 – Active high, 0 – Active low.
*						*  					*  POL[0] defines the polarity of interrupt source 0.
*	@  fTgtSensSel  (P)
*	`  Defines the Sensitivity of Fast interrupt target(s).
*			%unsigned  1  sens  0
*						*  					*  *
*						*  					*  Sensitivity. 1 – Edge triggered, 0 – level triggered.
*						*  					*  SENS[0] defines the sensitivity of interrupt source 0.
*	@  fIntE  (P)
*	`  Defines the enable bit for the Fast interrupt sources
*			%unsigned  32  ie  0
*						*  					*  *
*						*  					*  Interrupt Enable. IE[0] enables interrupt source 0.
*						*  					*  1 : interrupt is asserted when source is active
*						*  					*  0 : no interrupt is asserted because of this source.
*	@  fGIntE  (P)
*	`  Defines the global enable bit for the Fast interrupt.
*			%unsigned  1  gIe  0
*						*  					*  *
*						*  					*  Global Interrupt Enable. 1: enable 0: disable
*						*  					*  Fast interrupt target is asserted only when an interrupt source is enabled by its own IE bit in fIntE register, and gIe is 1.
*	@  nTgtPolSel  (P)
*	`  Defines the Polarity of Normal interrupt target(s).
*			%unsigned  1  pol  0
*						*  					*  *
*						*  					*  Polarity. 1 – Active high, 0 – Active low.
*						*  					*  POL[0] defines the polarity of interrupt source 0.
*	@  nTgtSensSel  (P)
*	`  Defines the Sensitivity of Normal interrupt target(s).
*			%unsigned  1  sens  0
*						*  					*  *
*						*  					*  Sensitivity. 1 – Edge triggered, 0 – level triggered.
*						*  					*  SENS[0] defines the sensitivity of interrupt source 0.
*	@  nIntE  (P)
*	`  Defines the enable bit for the Normal interrupt sources
*			%unsigned  32  ie  0
*						*  					*  *
*						*  					*  Interrupt Enable. IE[0] enables interrupt source 0.
*						*  					*  1 : interrupt is asserted when source is active
*						*  					*  0 : no interrupt is asserted because of this source.
*	@  nGIntE  (P)
*	`  Defines the global enable bit for the Normal interrupt.
*			%unsigned  1  gIe  0
*						*  					*  *
*						*  					*  Global Interrupt Enable. 1: enable 0: disable
*						*  					*  Normal interrupt target is asserted only when an interrupt source is enabled by its own IE bit in nIntE register, and gIe is 1.
**********************************************************************************************************************/
#ifdef	h_perPIC
#else
#define	h_perPIC
...
/**********************************************************************************************************************
*	INTERFACE: IRQ
*	`  to print the IRQs in defines files for ASIC and firmware use
*					:  dHubIntrAvio0  0
*					:  dHubIntrAvio1  1
*					:  dHubIntrVpro  2
*					:  ictlInst0CPUIrq  3
...
#define	\
	...
	#define	IRQ_ictlInst1CPUIrq 		0x4
	#define	IRQ_intrGfx3DM0 			0x5
	...
	#define	IRQ_sdio1_interrupt 		0x14
	#define	IRQ_spdif_rx_chovr_intr 	0x15
	#define	IRQ_spdif_rx_intr 			0x16
	#define	IRQ_ictlInst2CPUIrq 		0x17
	#define	IRQ_eth1Irq 				0x18
	#define	IRQ_dHubIntrAvio2 			0x19
	#define	IRQ_IntrHwBlk 				0x1A
	#define	IRQ_IntrFigo 				0x1B
	#define	IRQ_emmc_int 				0x1C
	#define	IRQ_nanfIntr 				0x1D
	#define	IRQ_pmuirq0 				0x1E
	#define	IRQ_pmuirq1 				0x1F
	#define	IRQ_l2ccintr_pl310 			0x20
	#define	IRQ_g_intr_gtop 			0x21
	#define	IRQ_g_intr_rxtx 			0x22
	#define	IRQ_g_intr_th_rxtx 			0x23
	#define	IRQ_g_intr_wakeup 			0x24
	#define	IRQ_g_intr_misc 			0x25
	#define	IRQ_pex2intr_int 			0x26
	#define	IRQ_pex2intr_err 			0x27
	#define	IRQ_TOTAL_IRQ 				0x28
...
#endif	/* _pic_h */
/**********************************************************************************************************************
*	ENDOFFILE (by "Interface Specification Compiler" ver-1.0): pic.h
**********************************************************************************************************************/
